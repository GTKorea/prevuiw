  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative flex min-h-[85vh] flex-col items-center justify-center px-4 pt-14 overflow-hidden">
        {/* Decorative comment pins — hidden on mobile, visible on md+ */}
        <div className="hidden md:block">
          {/* Pin with bubble — top left */}
          <div className="absolute top-[18%] left-[8%] lg:left-[12%]">
          ...
          <div className="absolute top-[22%] right-[8%] lg:right-[12%]">
          ...
          <div className="absolute bottom-[28%] right-[10%] lg:right-[14%]">
          ...
          <div className="absolute bottom-[25%] left-[6%] lg:left-[10%]">
            <div className="w-[100px] h-[50px] border-2 border-dashed border-yellow-500/40 rounded-lg bg-yellow-500/[0.03]">
          ...
          {/* Cursor Min — mid left */}
          <div className="absolute top-[55%] left-[10%] lg:left-[14%]">
            <svg width="16" height="20" viewBox="0 0 12 16" fill="none" className="drop-shadow-lg">
