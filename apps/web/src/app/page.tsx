  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative flex min-h-[85vh] flex-col items-center justify-center px-4 pt-14 overflow-hidden">
        ...
        {/* Pin with bubble — top left */}
        <div className="absolute top-[15%] left-[3%] sm:left-[6%] md:left-[8%]">
          <div className="h-6 w-6 sm:h-7 sm:w-7 rounded-full bg-blue-500 flex items-center justify-center text-[10px] sm:text-[11px] font-bold text-white shadow-lg shadow-blue-500/30 ring-4 ring-blue-500/10">
            1
          </div>
          <div className="mt-1.5 bg-neutral-800/90 border border-neutral-700 rounded-lg px-2.5 py-1.5 shadow-xl backdrop-blur-sm">
            <p className="text-[8px] sm:text-[9px] text-neutral-300 whitespace-nowrap">Love this layout!</p>
          </div>
        </div>

        {/* Resolved pin — top right */}
        <div className="absolute top-[20%] right-[3%] sm:right-[8%] md:right-[10%]">
          <div className="h-6 w-6 sm:h-7 sm:w-7 rounded-full bg-green-500 flex items-center justify-center text-white shadow-lg shadow-green-500/30 ring-4 ring-green-500/10">
        ...
        {/* Cursor James — bottom right */}
        <div className="absolute bottom-[22%] right-[5%] sm:right-[8%] md:right-[12%]">
          ...
          <span className="absolute top-5 left-4 bg-purple-500 rounded px-1.5 py-0.5 text-[7px] sm:text-[8px] text-white font-medium whitespace-nowrap shadow-lg">James</span>
        </div>

        {/* Drag area — bottom left */}
        <div className="absolute bottom-[18%] left-[3%] sm:left-[5%] md:left-[6%]">
          <div className="w-[80px] h-[40px] sm:w-[100px] sm:h-[50px] border-2 border-dashed border-yellow-500/40 rounded-lg bg-yellow-500/[0.03]">
            <div className="absolute -top-2 -right-2">
              <div className="h-4 w-4 sm:h-5 sm:w-5 rounded-full bg-yellow-500 flex items-center justify-center text-[8px] sm:text-[9px] font-bold text-white shadow-lg shadow-yellow-500/30">
                3
              </div>
            </div>
          </div>
        ...
        {/* Cursor Min — mid left */}
        <div className="absolute top-[58%] left-[5%] sm:left-[10%] md:left-[14%]">
          <svg width="16" height="20" viewBox="0 0 12 16" fill="none" className="drop-shadow-lg">
            <path d="M0 0L12 9.6L5.6 9.6L3.2 16L0 0Z" fill="#F97316"/>
          </svg>
          <span className="absolute top-5 left-4 bg-orange-500 rounded px-1.5 py-0.5 text-[7px] sm:text-[8px] text-white font-medium whitespace-nowrap shadow-lg">Min</span>
        </div>
