  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative flex min-h-[85vh] flex-col items-center justify-center px-4 pt-14 overflow-hidden">
        {/* Decorative elements — muted, ambient, hidden on mobile */}
        <div className="hidden md:block opacity-40">
          ...
          <div className="absolute top-[24%] right-[8%] lg:right-[12%]">
          ...
          {/* Dashed area — bottom left */}
          <div className="absolute bottom-[26%] left-[6%] lg:left-[10%]">
            <div className="w-[80px] h-[40px] border border-dashed border-yellow-500/50 rounded" />
          </div>
